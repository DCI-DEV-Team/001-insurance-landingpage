		...
		<section className="px-[50px] lg:px-[100px] xl:px-[200px] mt-20">
			<div className="flex xl:justify-between justify-center items-center gap-6 flex-wrap lg:flex-nowrap">
				<div className="w-full lg:w-1/2 h-full flex flex-col gap-4 justify-center lg:pr-20">
					...
					<h2 className="text-3xl font-bold text-[#093624]">Experienced Agents <br></br> You Can Trust</h2>
					<div className='border-b-4 border-[#BECEC7;] w-[14%] rounded mb-4'></div>
					<p className='text-[#4F4F4F] font-light leading-9'>Proin eget tortor risus. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Donec rutrum congue leo eget malesuada. Nulla porttitor accumsan tincidunt. Donec rutrum congue leo eget malesuada.</p>
				</div>
			...
			<div className='mt-40 md:mt-20 flex xl:justify-between justify-center items-center gap-6 flex-wrap-reverse lg:flex-nowrap'>
				<div className='w-5/6 lg:w-1/2 h-72 md:h-96 flex flex-col gap-4 justify-center items-center lg:pr-20'>
					<img src="./images/info-section-img.png" alt="Info Section Image, a Agent having a meeting with a Customer" className='[clip-path:inset(0%_0%_0%_0%_round_20%_3%_20%_3%);] h-full' />
				</div>
				<div className='w-full lg:w-1/2 h-full flex flex-col gap-4 justify-center lg:pr-20'>
				<h2 className="text-3xl font-bold text-[#093624]">We Got You Covered. Don’t <br></br> Get Caught Off Guard</h2>
					<div className='border-b-4 border-[#BECEC7;] w-[14%] rounded mb-4'></div>
					<p className='text-[#4F4F4F] font-light leading-9'>Proin eget tortor risus. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Donec rutrum congue leo eget malesuada. Nulla porttitor accumsan tincidunt. Donec rutrum congue leo eget malesuada.</p>
				</div>
			</div>
